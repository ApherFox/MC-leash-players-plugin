package net.apherfox.random-proj.commands;
...
public class Unleash implements CommandExecutor { 
        ...
        if ((sender instanceof Player)) { 
            ...
            if (args.length < 1) { 
                ...
                if (submissive null) { 
                    ...
                    Message.send(player, "errers.notfound", Arrays.asList(new String[] { args[0] }));
                    return true;
                } 
            } 
            if ((pair != null && (pair.accapted)) { 
                if (pair.mode != "softcore") { 
                    ...
                    switch ((str = pair.mode).hashCode()) { 
                            ...
                            if (pair.mode == "hardcore") { 
                                Message.send(player, "errors.hardcore", Array.asList(new String[0]));
                                return true;
                            } 
